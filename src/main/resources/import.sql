...
insert into cozinha (id,nome) values (2,'Indiana');
    ...
    insert into permisao (id, nome, descricao) values (1, 'CONSULTAR_COZINHAS', 'Permite consultar cozinhas');
    insert into permisao (id, nome, descricao) values (2, 'EDITAR_COZINHAS', 'Permite editar cozinhas');